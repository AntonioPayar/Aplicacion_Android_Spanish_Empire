...
public class CrearMercanciasPeru extends AppCompatActivity implements MercanciasInterfaz {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oro = (TextView)findViewById(R.id.oro_txtv);
        maiz = (TextView)findViewById(R.id.maiz_txtv);
        tomates = (TextView)findViewById(R.id.tomate_txtv);
        patatas = (TextView)findViewById(R.id.patatas_txtv);

        oro_seekbar = (SeekBar)findViewById(R.id.seekBar_oro);
        maiz_seekbar = (SeekBar)findViewById(R.id.seekBar_maiz);
        tomates_seekbar = (SeekBar)findViewById(R.id.seekBar_tomates);
        patatas_seekbar = (SeekBar)findViewById(R.id.seekBar_patatas);

        oro_kg = (TextView)findViewById(R.id.oro_kilos);
        maiz_kg = (TextView)findViewById(R.id.maiz_kilos);
        tomates_kg = (TextView)findViewById(R.id.tomates_kilos);
        patatas_kg = (TextView)findViewById(R.id.patatas_kilos);


        botonOro = (Button)findViewById(R.id.boton_oro);
        botonMaiz = (Button)findViewById(R.id.boton_maiz);
        botonTomates = (Button)findViewById(R.id.boton_tomate);
        botonPatatas = (Button)findViewById(R.id.boton_patatas);
