...
public class EnviarFlotasPlata extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enviar_flotas_plata);

        time = getIntent().getIntExtra("segundosMerc", 4);
        texto = "";

        control = Juego.getPanelDeControl();
        contenedor = (LinearLayout)findViewById(R.id.contenedorPlata);
        radio = (RadioGroup)findViewById(R.id.radioGroupPlata);
        embarca = (Button)findViewById(R.id.embarcarBotonPlata);
        imagen = (ImageView)findViewById(R.id.imageViewPlata);
    ...
    public void colocarBox() {
        ...
        while(it.hasNext()) {
            ...
            texto = this.control.getEspana().getPlata().getFlota().getArrayMercancias().get(id).getNombre()+" cantidad "+this.control.getEspana().getPlata().getFlota().getArrayMercancias().get(id).getTotalkg()+" kg ";
            nombre = this.control.getEspana().getPlata().getFlota().getArrayMercancias().get(id).getNombre().toUpperCase();
...
//            contenedor.addView(tv);
    ...
    public void recorrerPaises() {
        ...
        if(control.getEspana().getNuevaEspana().isSublevaciones()==false) {
            ...
            rb.setId(R.id.plataNuevaEspana);
            radio.addView(rb);
        }
        ...
        if(control.getEspana().getNuevaGranda().isSublevaciones()==false) {
            ...
            rb.setId(R.id.plataNuevaGranada);
            radio.addView(rb);
        }
        ...
        if(control.getEspana().getPlata().getFlota().getArrayMercancias().size()!=0) {
            try {
                if(texto.equals("")){
                    ...
                    switch (texto) {
                        case "NUEVA ESPAÑA":
                            control.getEspana().enviarFlota(control.getEspana().getPlata(), control.getEspana().getNuevaEspana());
                        ...
                        case "AUSTRIA":
                            ...
                            break;
                        case "BORGOÑA":
                            control.getEspana().enviarFlota(control.getEspana().getPlata(), control.getEspana().getBorgona());
...
//        int index = radio.indexOfChild(radioButton);
        ...
        switch (checkedId) {
            case R.id.plataCastilla:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.plata_to_castilla);
                break;
            case R.id.plataPeru:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.plata_to_peru);
                break;
            case R.id.plataNuevaEspana:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.plata_to_nueva_espana);
                break;
            case R.id.plataNuevaGranada:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.plata_to_nueva_granada);
                break;
            case R.id.plataAragon:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.plata_to_aragon);
                break;
            case R.id.plataBorgona:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.plata_to_borgona);
                break;
            case R.id.plataAustria: id = group.getCheckedRadioButtonId();

                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.plata_to_austria);
                break;
        }
