...
public class EnviarFlotasNuevaEspana extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enviar_flotas_nueva_espana);

        time = getIntent().getIntExtra("segundosMerc", 4);
        texto = "";

        control = Juego.getPanelDeControl();
        contenedor = (LinearLayout)findViewById(R.id.contenedorNuevaEspana);
        radio = (RadioGroup)findViewById(R.id.radioGroupNuevaEspana);
        embarca = (Button)findViewById(R.id.embarcarBotonNuevaEspana);
        imagen = (ImageView)findViewById(R.id.imageViewNE);
    ...
    public void colocarBox() {
        ...
        while(it.hasNext()) {
            ...
            texto = this.control.getEspana().getNuevaEspana().getFlota().getArrayMercancias().get(id).getNombre()+" cantidad "+this.control.getEspana().getNuevaEspana().getFlota().getArrayMercancias().get(id).getTotalkg()+" kg ";
            nombre = this.control.getEspana().getNuevaEspana().getFlota().getArrayMercancias().get(id).getNombre().toUpperCase();
...
//            contenedor.addView(tv);
    ...
    public void onClick(View v) {
        ...
        if(control.getEspana().getNuevaEspana().getFlota().getArrayMercancias().size()!=0) {
            try {
                if(texto.equals("")){
                    ...
                    switch (texto) {
                        case "CASTILLA":
                            control.getEspana().enviarFlota(control.getEspana().getNuevaEspana(), control.getEspana().getCastilla());
                            System.out.println("Importaciones Castilla");
                            control.getEspana().getNuevaEspana().verMercanciasImportacion();
                            break;
                        case "NUEVA GRANADA":
                            control.getEspana().enviarFlota(control.getEspana().getNuevaEspana(), control.getEspana().getNuevaGranda());
                            System.out.println("Importaciones Nueva Granada");
                            control.getEspana().getNuevaGranda().verMercanciasImportacion();
                            break;
                        case "PERU":
                            control.getEspana().enviarFlota(control.getEspana().getNuevaEspana(), control.getEspana().getPeru());
                            System.out.println("Importaciones Peru");
                            control.getEspana().getPeru().verMercanciasImportacion();
                            break;
                        case "PLATA":
                            control.getEspana().enviarFlota(control.getEspana().getNuevaEspana(), control.getEspana().getPlata());
                            System.out.println("Importaciones Plata");
                            control.getEspana().getPlata().verMercanciasImportacion();
                            break;
                        case "AUSTRIA":
                            control.getEspana().enviarFlota(control.getEspana().getNuevaEspana(), control.getEspana().getAustria());
                            System.out.println("Importaciones Austria ");
                            control.getEspana().getAustria().verMercanciasImportacion();
                            break;
                        case "BORGOÑA":
                            control.getEspana().enviarFlota(control.getEspana().getNuevaEspana(), control.getEspana().getBorgona());
                            System.out.println("Importaciones Borgoña");
                            control.getEspana().getBorgona().verMercanciasImportacion();
                            break;
                        case "ARAGON":
                            control.getEspana().enviarFlota(control.getEspana().getNuevaEspana(), control.getEspana().getAragon());
...
//                jmenu.removeAll();
                ...
                control.getEspana().getNuevaEspana().verMercancias();
                System.out.println("Mercancias FLota Castilla");
                control.getEspana().getNuevaEspana().getFlota().verMercancias();
...
//        int index = radio.indexOfChild(radioButton);
        ...
        switch (checkedId) {
            case R.id.NEaragon:
                ...
                imagen.setBackgroundResource(R.drawable.nueva_espana_to_aragon);
                break;
            case R.id.NEaustria:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.nueva_espana_to_austria);
                break;
            case R.id.NEborgona:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.nueva_espana_to_borgona);
                break;
            case R.id.NEcastilla:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.nueva_espana_to_castilla);
                break;
            case R.id.NENuevaGranada:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.nueva_espana_to_nueva_granada);
                break;
            case R.id.NEperu:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.nueva_espana_to_peru);
                break;
            case R.id.NEplata:
                id = group.getCheckedRadioButtonId();
                rb = (RadioButton)findViewById(id);
                texto = rb.getText().toString().toUpperCase();
                imagen.setBackgroundResource(R.drawable.nueva_espana_to_plata);
                break;
        }
