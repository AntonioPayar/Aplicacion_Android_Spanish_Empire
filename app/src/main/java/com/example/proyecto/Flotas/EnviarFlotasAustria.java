...
public class EnviarFlotasAustria extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    public void colocarBox() {
        ...
        while(it.hasNext()) {
            ...
            tv.setText(id+" "+this.control.getEspana().getAustria().getFlota().getArrayMercancias().get(id).getNombre()+" cantidad "+this.control.getEspana().getAustria().getFlota().getArrayMercancias().get(id).getTotalkg()+" kg ");
