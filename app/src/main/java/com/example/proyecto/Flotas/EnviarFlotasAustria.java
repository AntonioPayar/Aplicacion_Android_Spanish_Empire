...
public class EnviarFlotasAustria extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    public void colocarBox() {
        ...
        while(it.hasNext()) {
            ...
            texto = this.control.getEspana().getAustria().getFlota().getArrayMercancias().get(id).getNombre()+" cantidad "+this.control.getEspana().getAustria().getFlota().getArrayMercancias().get(id).getTotalkg()+" kg ";
            nombre = this.control.getEspana().getAustria().getFlota().getArrayMercancias().get(id).getNombre().toUpperCase();
...
//            contenedor.addView(tv);
    ...
    public void recorrerPaises() {
        ...
        if(control.getEspana().getNuevaEspana().isSublevaciones()==false) {
            ...
            rb.setId(R.id.austriaNuevaEspana);
            radio.addView(rb);
        }
        ...
        if(control.getEspana().getNuevaGranda().isSublevaciones()==false) {
            ...
            rb.setId(R.id.austriaNuevaGranada);
            radio.addView(rb);
        }
                    ...
                    adb3.setPositiveButton("Si", new AlertDialog.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            try {
                                switch (texto) {
                                    case "NUEVA ESPAÑA":
                                        control.getEspana().enviarFlota(control.getEspana().getAustria(), control.getEspana().getNuevaEspana());
                                    ...
                                    case "CASTILLA":
                                        ...
                                        break;
                                    case "BORGOÑA":
                                        control.getEspana().enviarFlota(control.getEspana().getAustria(), control.getEspana().getBorgona());
