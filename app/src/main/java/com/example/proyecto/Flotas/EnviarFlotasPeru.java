...
//GOGLE MAPAS
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment7,fragmentMaps01).commit();
    ...
    public void colocarBox() {
        ...
        while(it.hasNext()) {
            ...
            texto = this.control.getEspana().getPeru().getFlota().getArrayMercancias().get(id).getNombre()+" cantidad "+this.control.getEspana().getPeru().getFlota().getArrayMercancias().get(id).getTotalkg()+" kg ";
            nombre = this.control.getEspana().getPeru().getFlota().getArrayMercancias().get(id).getNombre().toUpperCase();
...
//        int index = radio.indexOfChild(radioButton)
        int id;
        RadioButton rb;
        this.fragmentMaps.ponerPutoOrigen("Peru");
